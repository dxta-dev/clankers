...
The clankers-daemon is a Go binary that owns all SQLite operations. Plugins communicate with it over JSON-RPC 2.0 via a Unix socket (or named pipe on Windows).
